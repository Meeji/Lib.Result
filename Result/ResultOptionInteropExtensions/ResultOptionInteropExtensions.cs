...
//        {
//            return result.Or(Option.None<TS>);
//        }
...
//        public static Result<TS, TF> ToResult<TS, TF>(this Option<TS> option, TF failure)
//        {
...
//        public static TR Do<TS, TF, TR>(this Option<Result<TS, TF>> option, Func<TS, TR> onSuccess, Func<TF, TR> onFailure, TF assumedFailure)
//        {
//            Throw.IfNull(option, nameof(option));
